...
assetCols2 <- c("hv213", "hv214", "hv208", "hv205", "hv244", "hv245", "hv243a", "hv206", "hv209", "hv247", "hv215", "hv246f", "hv207", "hv216", "hv243b", "hv246d")
targetCol <- c("hv270")
allCols <- c(assetCols2, targetCol)
...
# assetCols2 <- c("hv213", "hv214", "hv208", "hv205", "hv244", "hv245", "hv243a", "hv206", "hv209", "hv247", "hv215", "hv246f", "hv207", "hv216", "hv243b", "hv246d")
factorCols2 <- c("hv208","hv243a","hv243b", "hv205","hv213","hv214","hv215", "hv244")
df <- df %>% mutate_at(factorCols2, as.factor)
...
ggplot2::ggplot(data=cm_df, aes(x = nb.e1071.pred, y = testLabelsnb)) +
  ...
  labs(title="Confusion Matrix Heatmap V2")
```
