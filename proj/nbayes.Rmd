...
saveRDS(testLabelsnb, "./data/testLabelsnb.rds")
saveRDS(trainLabelsnb, "./data/trainLabelsnb.rds")
...
# read in labels
testLabelsnb <- readRDS("./data/testLabelsnb.rds")
trainLabelsnb <- readRDS("./data/trainLabelsnb.rds")
...
library(e1071)
nb.e1071 <- naiveBayes(trainDFnb, trainLabelsnb, laplace = 1)
nb.e1071.pred <- predict(nb, testDFnb)
...
# library(naivebayes)
# nb.nb <- naive_bayes(label ~ ., data = trainDFnb, usekernel = T, laplace = 1)
# plot(nb) 
```