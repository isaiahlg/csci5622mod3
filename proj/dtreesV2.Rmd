...
# export to RDS
saveRDS(sl19dtree, "./data/sl19dtreeV2.rds")
saveRDS(varsDtree, "./data/varsDtreeV2.rds")
```

## Prep data for DTree
```{r}
# reread in object
sl19dtree <- readRDS("./data/sl19dtreeV2.rds")
...
factorCols <- c("hv206","hv207","hv208","hv209","hv210","hv211","hv212","hv221","hv227","hv243a","hv243b","hv243c","hv243d","hv243e", "hv247","hv270")
df <- df %>% mutate_at(factorCols, as.factor)

summary(df)

# export clean record data format
saveRDS(df, "./data/sl19dtreeCleanV2.rds")
```

## Split Data into Balanced Training and Testing Samples
```{r}
# reread in object
sl19dtreeClean <- readRDS("./data/sl19dtreeCleanV2.rds")
df <- sl19dtreeClean

library(dplyr)
# rename target variable to "label"
colnames(df)[colnames(df) == "hv270"] ="label"
...
# export samples
saveRDS(testdf, "./data/testdfdtreesV2.rds")
saveRDS(traindf, "./data/traindfdtreesV2.rds")
```

## Decision Tree Analysis
```{r}
# read in training data frame
traindf <- readRDS("./data/traindfdtreesV2.rds")
...
# test on test df
testdf <- readRDS("./data/testdfdtreesV2.rds")
...
saveRDS(sl19dtree2, "./data/sl19dtree2V2.rds")
...
# convert categorical columns to factors
factorCols <- c("hv206","hv207","hv208","hv209","hv210","hv211","hv212","hv221","hv227","hv243a","hv243b","hv243c","hv243d","hv243e", "hv247","hv270", "hv205","hv213","hv214","hv215", "hv244")
df <- df %>% mutate_at(factorCols, as.factor)
saveRDS(df, "./data/sl19dtreeClean2V2.rds")

# split data into test/train
sl19dtreeClean2 <- readRDS("./data/sl19dtreeClean2V2.rds")
df <- sl19dtreeClean2
colnames(df)[colnames(df) == "hv270"] ="label"
...
# export samples
saveRDS(testdf, "./data/testdfdtrees2V2.rds")
saveRDS(traindf, "./data/traindfdtrees2V2.rds")
traindf <- readRDS("./data/traindfdtrees2V2.rds")
...
# pull in and prep test data
testdf <- readRDS("./data/testdfdtrees2V2.rds")
target <- testdf$label
testdf <- testdf[,!names(df) %in% targetCol]
